...
export default class Footer extends Component {
    ...
    return (
        <div className="add-company-footer">
          <div className="application-width">
            <div className="row">
              {this.departmentColumn('Computer Science Department',
                  this.departmentWidget)}
            </div>
          </div>
        </div>
    );
            ...
            <div className="footer-copyright">
              ...
              <div className="footer-logo-wrapper">
                <a href="http://www.colostate.edu/"
                   className="company-sub-widget" target="_blank">
                  <FooterLogo/>
                </a>
              </div>
            </div>
  ...
  footerCopyright() {
    ...
    return (
        <div>
          <ul>
            <li><a href="http://admissions.colostate.edu"
                   className="company-sub-widget">Apply to CSU</a></li>
            <li><a href="http://www.colostate.edu/info-contact.aspx"
                   className="company-sub-widget">Contact CSU</a></li>
            <li><a href="http://www.colostate.edu/info-disclaimer.aspx"
                   className="company-sub-widget">Disclaimer</a></li>
            <li><a href="http://www.colostate.edu/info-equalop.aspx"
                   className="company-sub-widget">Equal Opportunity</a></li>
            <li><a href="http://www.colostate.edu/info-privacy.aspx"
                   className="company-sub-widget">Privacy Statement</a></li>
            <br/>
            <li><p>© {year} Colorado State University
              - {this.departmentName()} Department, Fort Collins, CO 80523</p>
            </li>
          </ul>
        </div>
    );
